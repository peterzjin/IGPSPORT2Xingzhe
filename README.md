...
依赖见 requirements.txt。仅覆盖 iGPSPORT→行者，佳明渠道仍用 `ActivitySync.py`。
...
- 支持各个平台互相转换，目前支持：IGPSport，行者，<del>国际版佳明，大陆版佳明</del>，高驰，迈金，IGPSport国际版
- 若使用该付费服务出现问题可邮箱联系：abigeater@163.com